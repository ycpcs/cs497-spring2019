...
All the labs and assignments are cross platform so you may use either Visual Studio 2017 (Windows), XCode (Mac), or command line (Linux). Refer to the [Resources](resources/index.html) page for installation instructions for the various external tools and libraries needed for the course.
